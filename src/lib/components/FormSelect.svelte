...
<Form.Field {form} {name}>
	<Form.Control>
		{#snippet children({ props })}
			...
			<select
				{...props}
				class="h-10 w-full appearance-none rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7F00FF] focus-visible:ring-offset-2"
