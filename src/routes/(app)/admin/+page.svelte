...
<div class="min-h-full space-y-8 bg-white/50 pb-8 font-sans">
	...
	<div class="flex flex-col justify-between gap-4 md:flex-row md:items-end">
		<div class="space-y-1">
			<h1 class="text-[22px] font-semibold tracking-tight text-gray-900">Admin Area</h1>
			<p class="text-[13px] text-gray-500">
				Monitor business operations, active orders, revenue, and clients.
			</p>
		</div>
	...
	<div class="space-y-4 pt-2">
		<h2 class="text-[16px] font-semibold text-gray-900">Orders Management</h2>
		<!-- Table -->
		<div
				...
				<table class="w-full whitespace-nowrap text-left text-[13px] text-gray-600">
					<thead class="border-b border-gray-100 bg-white text-[12px] font-medium text-gray-500">
						<tr>
							...
							<th class="px-4 py-3">
								<div class="flex cursor-pointer items-center gap-1.5 hover:text-gray-700">
									Client Name <ArrowUpDown class="h-3 w-3 text-gray-400" />
								</div>
							</th>
							<th class="px-4 py-3">
								<div class="flex cursor-pointer items-center gap-1.5 hover:text-gray-700">
							...
							<th class="px-4 py-3">
								<div class="flex cursor-pointer items-center gap-1.5 hover:text-gray-700">
									Deadline <ArrowUpDown class="h-3 w-3 text-gray-400" />
								</div>
							</th>
							<th class="px-4 py-3">
								<div class="flex cursor-pointer items-center gap-1.5 hover:text-gray-700">
							...
							<tr class="group font-medium transition-colors hover:bg-gray-50/60">
								...
								<td class="px-4 py-4">
									<div class="flex items-center justify-center gap-2">
										...
										<button
											class="p-1 text-gray-400 transition-colors hover:text-[#6534FF]"
											title="Edit / Assign"
										>
											<Edit class="h-4 w-4" />
										</button>
										<button
											class="p-1 text-gray-400 transition-colors hover:text-rose-600"
											title="Delete"
										>
